...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["558892594715@s.whatsapp.net"] // coloque seu numero
			const mod = [ownerNumber,"558892594715@s.whatsapp.net"]//seu numero
			const adminbotnumber = ["55889594715@s.whatsapp.net"]//seu numero
			const frendsowner = ["558892594715@s.whatsapp.net"]//seu numero
			const premium = ["558892594715@s.whatsapp.net","557186613965@s.whatsapp.net",] 
